...
def search_task(search_info: TaskSearch) -> List[dict]:
    ...
    result = [task for task in tasks if keyword in task["title"]]
    return result

@app.get("/tasks/search")
def api_search_task(keyword: str):
    search_model = TaskSearch(keyword=keyword)
    return search_task(search_model)
